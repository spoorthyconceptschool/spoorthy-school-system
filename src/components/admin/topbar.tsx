    ...
    return (
        <>
            ...
            <MobileHeader
                ...
                leftTrigger={<MobileSidebar />}
            />

            {/* Desktop Header */}
            <header
                className={`h-16 sticky top-0 z-40 transition-all duration-300 hidden lg:flex items-center justify-between px-2 md:px-4 ${scrolled
                    ? "bg-[#0A192F]/80 backdrop-blur-md border-b border-[#64FFDA]/10 shadow-lg"
                    : "bg-[#0A192F] lg:bg-transparent"
                    }`}
            >
