...
export default function StaffAttendanceManager({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.log(`[Optimistic Staff Attendance] Successfully synchronized. Changes: ${data.changesCount || 0}`);
        } catch (e: any) {
            console.error("[Optimistic Staff Attendance] Sync failed, reverting state:", e);
