            ...
            if (hasPendingTerm || hasPendingCustom) {
                ...
                if (uid) {
                    ...
                    batch.set(notifRef, {
                        ...
                        message: `Dear Parent, you have outstanding Fee Payment and Custom Fees (Dues) for ${ledger.studentName}. Please clear the balance of ₹${(ledger.totalFee - ledger.totalPaid).toLocaleString()} at the earliest.`,
                        type: "FEE_ALERT",
                        status: "UNREAD",
